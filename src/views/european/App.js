...
import LiveDetailsPage from "./LiveDetails.js";
import MultiViewPage from "./MultiView.js";
import PrematchPage from "./Prematch.js";
                    ...
                    <Root>
                        ...
                        <European_Buttons_Row_settings>
                            <Tooltip text="This is calculator!">
                                <European_Button_var_settings icon={<Symbol sportId={"calculator_v2"} />} />
                            </Tooltip>
                            <Tooltip text="This is calculator!">
                                <European_Button_var_settings icon={<Symbol sportId={"settings_v2"} />} />
                            </Tooltip>
                        </European_Buttons_Row_settings>
                        <Scroll>
                            <SidebarTabs>
                                <SidebarTab title="Prematch" count={200}>
                                    <Control onChange={() => {}} />
                                    <SidebarItem view={"european"} variant={"favorite"} name="favorites" count={0} />
                                    <SidebarItem view={"european"} variant={"league"} name="league name" />
                                    <SidebarItem view={"european"} variant={"league"} name="league name" />
                                    <SidebarItem view={"european"} variant={"league"} name="league name" />
                                    ...
                                    <SidebarItem view={"european"} variant={"country"} name="country name" />
                                    <SidebarItem view={"european"} variant={"league"} name="league name" />
                                </SidebarTab>
                            ...
                            <div className="european_view_home_widgets_list">
                                <div className="european_view_home_widget_root">
                                    ...
                                    <div className="european_view_home_widget_content">
                                        <Button variant="accent" className="child_btn" text={"Check"} />
                                    </div>
                                </div>
                                    ...
                                    <div className="european_view_home_widget_content">
                                        ...
                                        <div className="action_container">
                                            <Tooltip text="This is Button!">
                                                <Button className="child_btn" text={"Generate"} variant="accent" />
                                            </Tooltip>
                                        </div>
                                    </div>
                                </div>
