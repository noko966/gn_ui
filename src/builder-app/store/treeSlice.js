            ...
            children: [
                {
                    ...
                    cn: "dg_layout",
                    children: [
                        { el: "span", type: "text", cn: "dg_text", children: null, textContent: "text piece 1" },
                    ],
                },
                {
                    name: "layout",
                    ...
                    cn: "dg_layout",
                    children: [
                        { el: "span", type: "text", cn: "dg_text", children: null, textContent: "text piece 2" },
                    ],
                },
            ],
        },
...
function siblingsWithSameBase(parent, base) {
    ...
    return parent.children.map((n, i) => ({ n, i })).filter(({ n }) => sameBaseClass(n) === base);
}
...
function reCalcVariantForGroup(state, path) {
    ...
    group.forEach(({ n, i }, idx) => {
        ...
        if (v) n.variantClass = v;
        else delete n.variantClass;
    });
}
...
const treeSlice = createSlice({
    ...
    reducers: {
        ...
        setLayoutType(state, action) {
            ...
            const payload = typeof action.payload === "string" ? { type: action.payload } : action.payload || {};
            ...
            switch (kind) {
                ...
                case "fixed":
                    ...
                    const finalWidth = widthPx || node.styles.width || node.styles["--sk_width"] || 120;
